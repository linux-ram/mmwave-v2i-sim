# How to cite mmwave-v2i-sim

Use these entries when referencing this project in papers, theses, or reports.

## Paper title (technical report)

**A Modular Python Simulator for mmWave Vehicle-to-Infrastructure Link-Layer Research**
...
## BibTeX — original MATLAB simulator (optional, secondary)
...
GitHub’s **Cite this repository** button uses [CITATION.cff](../CITATION.cff). The `preferred-citation` field points to the technical report title above.
